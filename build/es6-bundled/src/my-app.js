...
</iron-iconset-svg>`;document.head.appendChild($_documentContainer$8.content);const bundledImportMeta$2=babelHelpers.objectSpread({},meta,{url:new URL("../node_modules/plastic-resize-aware/plastic-resize-aware.js",meta.url).href});class PlasticResizeAware extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: block;
        }
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]">
          ...
          <iron-selector selected="[[page]]" attr-for-selected="name" class="drawer-list" role="navigation">
            ...
            <span style="font-size:smaller;">About the demo project</span></a>
          </iron-selector>
        </app-drawer>
        ...
        <app-header-layout has-scrolling-region="">
          ...
          <app-header slot="header" condenses="" reveals="" effects="waterfall">
            <app-toolbar>
              ...
              <div main-title="">plastic-map-marker-svg Demonstrations</div>
            </app-toolbar>
          </app-header>
...
</plastic-map-marker-set>`;document.head.appendChild($_documentContainer$10.content);const $_documentContainer$11=document.createElement("template");$_documentContainer$11.innerHTML=`<dom-module id="shared-styles">
  <template>
    <style>
      .card {
        margin: 24px;
...
</dom-module>`;document.head.appendChild($_documentContainer$11.content)});